...
Initialize a project with a default `AGENTS.md` file for providing context to the agent. If `AGENTS.md` already exists, `sc init` stops without overwriting it.
