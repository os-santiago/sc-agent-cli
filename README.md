...
Initialize a project with a default `AGENTS.md` file for providing context to the agent. If `AGENTS.md` already exists, the command keeps it unchanged and prints guidance instead of overwriting it.
