...
**SC-Agent CLI** (v0.4.0) is a provider-agnostic AI agent CLI tool that supports any OpenAI-compatible API (OpenAI, Anthropic, Ollama, LM Studio, NVIDIA, Groq, Together, etc.). It provides:
